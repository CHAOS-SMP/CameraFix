...
@Pseudo
@Mixin(targets = "net.minecraft.network.protocol.game.ServerboundMovePlayerPacket$PosRot", remap = false)
public class NamedMixinServerboundMovePlayerPosRotPacket {
    @ModifyArg(
